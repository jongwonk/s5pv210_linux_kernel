...
static int s5pv210_gpio_set_debounce(struct gpio_chip *chip, unsigned offset,
				    unsigned debounce)
{
  /*
...
*/
	  ...
	  long var;
/*	  
	  var = readl(S5PV210_GPC1_INTFLTCON0);
	  var |= (0x5|0x80);
	  var |= (0x500|0x8000);
	  var |= (0x50000|0x800000);
	  writel(var, S5PV210_GPC1_INTFLTCON0);

	  printk("S5PV210_GPC1_INTFLTCON0 : %08X\n",readl(S5PV210_GPC1_INTFLTCON0));
	  var = readl(S5PV210_GPA1_INTFLTCON0);
	  var |= (0x50000|0x800000);
	  var |= (0x5000000|0x80000000);
	  writel(var, S5PV210_GPA1_INTFLTCON0);
	  printk("S5PV210_GPA1_INTFLTCON0 : %08X\n",readl(S5PV210_GPA1_INTFLTCON0));
	  
	  var = readl(S5PV210_GPC1_INT_MASK);
	  var = 0x08;
	  writel(var, S5PV210_GPC1_INT_MASK);
	  printk("S5PV210_GPC1_INT_MASK : %08X\n",readl(S5PV210_GPC1_INT_MASK));
	  
	  var = readl(S5PV210_GPA1_INT_MASK);
	  var = 0x03;
	  writel(var, S5PV210_GPA1_INT_MASK);
	  printk("S5PV210_GPA1_INT_MASK : %08X\n",readl(S5PV210_GPA1_INT_MASK));
*/

/*
  	  var = readl(S5PV210_GPC1_BASE);
	  var |= 0x0F;
	  writel(var, S5PV210_GPC1_BASE);
*/	  
...
static struct samsung_gpio_chip s5pv210_gpios_4bit[] = {
#ifdef CONFIG_CPU_S5PV210
	{
		...
		.chip	= {
			...
			.label	= "GPA1",
			.set_debounce = s5pv210_gpio_set_debounce,
		},
	}, {
		.chip	= {
			.base	= S5PV210_GPB(0),
