...
#define S5P_EINTCON(x)			(S5PV210_EINT30CON + ((x) * 0x4))
...
#define S5P_EINTFLTCON(x)		(S5PV210_EINT30FLTCON0 + ((x) * 0x4))
...
#define S5P_EINTMASK(x)			(S5PV210_EINT30MASK + ((x) * 0x4))
...
#define S5P_EINTPEND(x)			(S5PV210_EINT30PEND + ((x) * 0x4))
#define S5PV210_EINT30CON		(S5P_VA_GPIO + 0xE00)
